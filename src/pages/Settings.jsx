...
export default function Settings() {
  ...
  return (
    <div className="container mx-auto max-w-[720px]">
      <h1 className="mb-1.5 text-h2 text-textmuted">Réglages</h1>
      ...
      <Card className="mb-5 p-6 max-sm:p-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-[8px] border border-edgered bg-tintred px-4 py-2.5 text-sm font-bold text-red transition-colors hover:bg-tintred"
        >
      ...
      <Card className="p-6 max-sm:p-4">
        <div className="mb-1.5 flex items-center gap-2.5">
          <span className="flex h-9 w-9 items-center justify-center rounded-[8px] bg-hover text-textmuted"><Icon name="book" size={18} /></span>
        ...
        <button
          ...
          className="mt-4 inline-flex items-center gap-2 rounded-[8px] border border-borderline bg-transparent px-4 py-2.5 text-sm font-bold text-textmain transition-colors hover:bg-hover"
        >
