    ...
    <div className="ambient container mx-auto max-w-[1080px]">
      ...
      <div className="mb-5 flex flex-wrap gap-3">
        <input
          ...
          className="w-full max-w-[360px] rounded-xl border border-borderline bg-secondary px-4 py-3 pl-10 text-[15px] text-textmain outline-none transition-[border,box-shadow] focus:border-violet focus:"
          ...
          {[
            ...
            <button
              ...
              className={`rounded-full border px-3.5 py-1.5 text-[13px] font-semibold transition-colors ${
                filter === x.f ? "border-violet bg-violet text-onaccent" : "border-borderline bg-transparent text-textmuted hover:bg-hover hover:text-textmain"
              }`}
            >
              {x.l}
            </button>
