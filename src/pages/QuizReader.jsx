  ...
  return (
    <div className="container mx-auto max-w-[760px]">
      ...
      {done ? (
        ...
        <div className="rounded-[8px] border border-borderline bg-secondary p-6 max-sm:p-4">
          ...
          {isFlash ? (
            <div className="persp">
              ...
              >
                <div className="backface-hidden absolute inset-0 flex flex-col items-center justify-center rounded-[8px] border border-borderline bg-hover p-6 text-center">
                  <Icon name="target" size={22} className="text-textmain" />
                ...
                <div className="backface-hidden rotate-y-180 absolute inset-0 flex flex-col items-center justify-center overflow-y-auto rounded-[8px] border border-borderline bg-hover p-6 text-center">
          ...
          {((isFlash && flipped) || (!isFlash && sel != null)) && (
            <div className="mt-5 flex items-center justify-center gap-3 border-t border-borderline pt-4">
              ...
              <button
                onClick={() => mark(false)}
                className={`inline-flex items-center gap-1.5 rounded-[8px] border px-3.5 py-2 text-[12.5px] font-bold transition-colors ${known[idx] === false ? "border-red bg-tintred text-red" : "border-borderline bg-transparent text-textmain hover:bg-hover"}`}
              >
      ...
      <div className="mt-5 flex items-center justify-between gap-3">
        <button
          onClick={prev}
          disabled={idx === 0}
          className="inline-flex h-11 items-center gap-1.5 rounded-[8px] border border-borderline bg-transparent px-4 text-sm font-bold text-textmain transition-colors hover:bg-hover disabled:cursor-not-allowed disabled:opacity-35"
        >
