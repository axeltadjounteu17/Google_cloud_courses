    ...
    <div className="container mx-auto max-w-[1080px]">
      <Card className="mb-5 p-6 max-sm:p-4">
        ...
        <div className="mb-2 flex items-center gap-3">
          <span className="flex h-[42px] w-[42px] items-center justify-center rounded-xl bg-blue/15 text-cyan"><Icon name="layers" size={22} /></span>
          <h1 className="text-[22px]">Diapositives du cours</h1>
        </div>
        <div className="mb-3 flex flex-wrap gap-2.5">
          <Badge color="blue">{s.decks.length} modules</Badge>
